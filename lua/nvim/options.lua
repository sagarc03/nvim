...
if vim.g.neovide then
	options["g"]["gui_font_default_size"] = 23
	options["g"]["gui_font_size"] = vim.g.gui_font_default_size
	options["g"]["gui_font_face"] = "JetBrainsMono Nerd Font Mono"
	options["g"]["neovide_refresh_rate"] = 144
	options["g"]["neovide_profiler"] = false
	options["g"]["neovide_cursor_vfx_mode"] = "torpedo"
	options["opt"]["guifont"] = string.format("%s:h%s", vim.g.gui_font_face, vim.g.gui_font_size)
end
